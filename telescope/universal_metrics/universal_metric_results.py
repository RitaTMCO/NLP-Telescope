...
class MultipleUniversalMetricResult():
    def __init__(
        ...
        for systems_universal_metric_results in list(systems_universal_metrics_results.values()):
            assert systems_universal_metric_results.ref == ref_x
            assert systems_universal_metric_results.metrics == metrics_x
            assert systems_universal_metric_results.universal_metric == universal_metric_x

...
def plot_bootstraping_result(bootstrap_result: BootstrapResult):
    data = []
    metric_x_wins = (bootstrap_result.win_count[0] / sum(bootstrap_result.win_count)) * 100
    metric_y_wins = (bootstrap_result.win_count[1] / sum(bootstrap_result.win_count)) * 100
    metric_ties = (bootstrap_result.win_count[2] / sum(bootstrap_result.win_count)) * 100
    data.append(
        {

...
class TestWeightedSum(unittest.TestCase):
    ...
    weighted_sum = WeightedSum(multiple_metric_result,"weighted-sum",{"mock_1":0.5,"mock_2":0.6,"mock_3":0.4,
                                                                         "COMET":1.0, "TER":0.7, "mock_4":0.3})


    def test_score_calculation_and_ranking(self):

        expected_sys_score = {"Sys 1": 0.15, "Sys 2":1.71, "Sys 3":2.45}
        expected_sys_rank = {"Sys 1": 3, "Sys 2": 2, "Sys 3": 1}

        result = self.weighted_sum.universal_score_calculation_and_ranking(self.testset)
    
        sys_scores = WeightedSum.universal_score(list(self.systems_names.keys()), self.metrics_scores, "", {"mock_1":0.5,"mock_2":0.6,"mock_3":0.4,
                                                                         "COMET":1.0, "TER":0.7, "mock_4":0.3})

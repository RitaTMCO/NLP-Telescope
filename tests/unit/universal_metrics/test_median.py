...
class TestMedian(unittest.TestCase):
    ...
    metrics = ["mock_1","mock_2","mock_3","COMET", "TER", "mock_6"]
    ...
    multiple_metric_result_odd = {"mock_1":multiple_result_1,"mock_2":multiple_result_2,"mock_3":multiple_result_3, "COMET":multiple_result_4, "TER":multiple_result_5}
    multiple_metric_result_even = {"mock_1":multiple_result_1,"mock_2":multiple_result_2,"mock_3":multiple_result_3, "COMET":multiple_result_4, "TER":multiple_result_5, "mock_6":multiple_result_6}
    ...
    def test_score_calculation_and_ranking_odd(self):
        ...
        expected_sys_score = {"Sys 1": 0.1, "Sys 2":0.3, "Sys 3":0.3}
        expected_sys_rank = {"Sys 1": 2, "Sys 2": 1, "Sys 3": 1}
    ...
    def test_score_calculation_and_ranking_even(self):
        ...
        expected_sys_score = {"Sys 1": 0.1, "Sys 2":0.5, "Sys 3":0.6}

...
class TestWithDatasetsAndLibrary(unittest.TestCase):
    ...
    def test_bias_evalaution_en(self):
        ...
        result = self.gender_bias_evaluation_en.evaluation(self.testset_en, "with dataset and library")
    ...
    def test_bias_evalaution_pt(self):
        ...
        result = self.gender_bias_evaluation_pt.evaluation(self.testset_pt, "with dataset and library")
        ...
        self.assertDictEqual(result.systems_bias_results["Sys 1"].text_groups_sys_per_seg,
                             {0:[{'gender': 'female', 'term': 'ela'},{'gender': 'female', 'term': 'uma'}]})